...
try:
    ...
    warnings.warn(
        "Missing metaworld Install: `pip install PSBL[envs]` or `pip install git+https://github.com/Farama-Foundation/Metaworld.git@04be337a12305e393c0caf0cbf5ec7755c7c8feb`",
        category=Warning,
    )
import gymnasium as gym
import numpy as np

from PSBL.envs.env_utils import space_convert
...
class KShotMetaworld(gym.Env):
    ...
    def reset(self, *args, **kwargs):
        ...
        return self.get_obs(obs[0], True), {}
