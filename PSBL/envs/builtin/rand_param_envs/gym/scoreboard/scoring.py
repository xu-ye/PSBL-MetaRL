...
def score_from_remote(url):
    ...
    return score_from_merged(episode_lengths, episode_rewards, episode_types, timestamps, initial_reset_timestamp,
                             spec.trials, spec.reward_threshold)
...
def score_from_merged(episode_lengths, episode_rewards, episode_types, timestamps, initial_reset_timestamp, trials,
                      reward_threshold):
...
def benchmark_score_from_local(benchmark_id, training_dir):
    ...
    for training_dir in directories:
        ...
        benchmark_result = spec.score_evaluation(env_id, results['data_sources'], results['initial_reset_timestamps'],
