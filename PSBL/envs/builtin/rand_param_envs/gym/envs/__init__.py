from PSBL.envs.builtin.rand_param_envs.gym.envs.registration import registry, register, make, spec
...
register(
    ...
    # (Reproduce by running 'from PSBL.envs.builtin.rand_param_env2 import gym; h = gym.make('Go9x9-v0'); h.seed(1); h.reset(); h.step(15); h.step(16); h.step(17)' a few times.)
    #
