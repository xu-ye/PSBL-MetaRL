...
from PSBL.envs.builtin.rand_param_envs.gym.utils import closer, reraise
...
class Wrapper(Env):
    ...
    @spec.setter
    def spec(self, spec):
        # Won't have an env attr while in the __new__ from PSBL.envs.builtin.rand_param_env2.gym.Env
